...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      className="w-full bg-white dark:bg-neutral-950 font-sans py-0 md:px-10"
      ref={containerRef}
    >
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto mt-0 pb-20">
        {data.map((item, index) => (
          <div
            key={index}
            className="flex justify-start pt-8 md:gap-10"
          >
